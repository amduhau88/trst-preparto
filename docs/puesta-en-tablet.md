...
| Hay que borrar datos del sitio, desinstalar o reinstalar | **Antes**, entrar con una cuenta admin → Ajustes → **Copiar pendientes** y guardar ese texto. La cola vive en el almacenamiento del navegador y se borra con él. |
